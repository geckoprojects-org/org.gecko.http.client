...
import org.gecko.http.client.cookie.DefaultCookieHandler.CookieHandlerConfig;
...
public class DefaultCookieHandler extends CookieHandler {
    ...
    public static @interface CookieHandlerConfig {
        ...
        @AttributeDefinition()
        String cookieStore_target() default "(java.net.CookieStore.type=DEFAULT)";
    }

    public static final String PID = "org.gecko.http.client.cookie.DefaultCookieHandler";
