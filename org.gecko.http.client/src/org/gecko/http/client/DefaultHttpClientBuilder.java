...
@HttpClientBuilderName(value = ".default")
@ServiceDescription(DefaultHttpClientBuilder.DESCRIPTION)
@Component(service = Builder.class, immediate = true)
public class DefaultHttpClientBuilder extends AbstractHttpClientBuilder {

    protected final static String DESCRIPTION = "The default java.net.http.HttpClient.Builder that uses similar settings"
            + " like 'HttpClient.newBuilder()'.";
