...
import org.geckoprojects.http.client.util.publisher.MultiPartBodyPublisher;
...
public class MultiPartBodyPublisherTest {
    ...
    @Test
    public void test(@InjectService HttpClient client, @TempDir Path tempDir) throws IOException {
