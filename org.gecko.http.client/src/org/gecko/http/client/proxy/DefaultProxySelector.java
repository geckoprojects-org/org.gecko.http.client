...
@Component(service = ProxySelector.class, immediate = true, configurationPid = DefaultProxySelector.PID)
public class DefaultProxySelector extends ProxySelector {

    public static final String PID = "org.gecko.http.client.proxy.DefaultProxySelector";
