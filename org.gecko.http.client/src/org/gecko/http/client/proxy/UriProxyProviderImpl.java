...
package org.gecko.http.client.proxy;
...
import org.gecko.http.client.proxy.UriProxyProviderImpl.FilterableProxyConfig;
...
@Component(service = UriProxyProvider.class, configurationPid = UriProxyProviderImpl.PID)
public class UriProxyProviderImpl implements UriProxyProvider {

    public static final String PID = "org.gecko.http.client.proxy.Proxy";
