...
public class CustomHttpClientTest {
    ...
    @Test
    @WithFactoryConfiguration(factoryPid = org.gecko.http.client.Constants.PID_HTTP_CLIENT_CUSTOM, name = "a", location = "?", properties = {
    ...
    @Test
    @WithFactoryConfiguration(factoryPid = org.gecko.http.client.Constants.PID_HTTP_CLIENT_CUSTOM, name = "b", location = "?", properties = {
    ...
    @Test
    @WithFactoryConfiguration(factoryPid = org.gecko.http.client.Constants.PID_HTTP_CLIENT_AUTH_BASIC, name = "b", location = "?", properties = {
    ...
    @Test
    @WithFactoryConfiguration(factoryPid = org.gecko.http.client.Constants.PID_HTTP_CLIENT_AUTH_BASIC, name = "b", location = "?")
    @WithFactoryConfiguration(factoryPid = org.gecko.http.client.Constants.PID_HTTP_CLIENT_PROXY_PROVIDER_DEFAULT, name = "X", location = "?", properties = {
    ...
    @WithFactoryConfiguration(factoryPid = org.gecko.http.client.Constants.PID_HTTP_CLIENT_PROXY_PROVIDER_DEFAULT, name = "Z", location = "?", properties = {
            @Property(key = "authBasicEnable", value = "true"),
