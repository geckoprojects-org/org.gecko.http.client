...
package org.geckoprojects.http.client.impl.proxy;
...
@Component(service = ProxySelector.class, immediate = true, configurationPid = org.geckoprojects.http.client.Constants.PID_HTTP_CLIENT_PROXY_SELECTOR_DEFAULT)
