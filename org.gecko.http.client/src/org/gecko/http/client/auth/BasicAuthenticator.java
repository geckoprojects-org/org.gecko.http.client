...
package org.gecko.http.client.auth;
...
import org.gecko.http.client.auth.BasicAuthenticator.BasicAuthenticatorConfig;
...
@Component(service = Authenticator.class, configurationPid = BasicAuthenticator.PID)
public class BasicAuthenticator extends Authenticator {
    ...
    public static final String PID = "org.gecko.http.client.auth.BasicAuthenticator";
    ...
    public void setup(BasicAuthenticatorConfig config) {
        ...
        this.config = config;
        serverPassAuthentication = config.serverBasicAuthEnable()
                ? new PasswordAuthentication(config.serverBasicAuthUsername(),
                        config.serverBasicAuthPassword()==null?null:   config.serverBasicAuthPassword().toCharArray())
                : null;
    }
